                                    ...
                                    <div class="breadcrumbs-wrap">
                                        <div class="display">
                                            ...
                                            <ul class="breadcrumbs list-none">
                                                ...
                                                <li id="brcr_1"><a href="<?php the_permalink(259); ?>"><span>Nghiên cứu<i class="fa fa-lg fa-angle-right"></i></span></a></li>
                                                <li id="brcr_2">
                                                  <?php
                        ...
                        if (!empty($child_terms) && !is_wp_error($child_terms)) {
                             foreach ($child_terms as $child) {
                                 $term_link = get_term_link($child);
                                         $post_args = array(
                                        'post_type'      => 'examine',
                                        'posts_per_page' => 1, // hoặc nhiều nếu bạn muốn
                                        'tax_query'      => array(
                                            array(
                                                'taxonomy' => $term->taxonomy,
                                                'field'    => 'term_id',
                                 ...
                                 <div class="news_column">
                                     ...
                                     <div class="panel-heading">
                                         <ul class="list-inline sub-list-icon" style ="margin: 0">
                                             <li>
                                                 <h4>
                                                     <a href="<?php echo esc_url($term_link)?>"><span><?php  echo esc_html($child->name) ?></span></a>
                                                 </h4>
                                             </li>
                                         </ul>
                                     </div>
