                            ...
                            <div class="clearfix">
                                <div class="col-xs-24 col-sm-18 col-md-18">
                                    <div class="breadcrumbs-wrap">
                                        ...
                                        <ul class="breadcrumbs list-none"><li id="brcr_0"><a href="/index.php"><span>Trang chủ<i class="fa fa-lg fa-angle-right"></i></span></a></li><li id="brcr_1"><a href="<?php the_permalink(460)?>"><span>Cựu sinh viên<i class="fa fa-lg fa-angle-right"></i></span></a></li><li id="brcr_2">
                                                                   <?php
...
if (is_singular('alumni')) {
    $terms_of_post = get_the_terms(get_the_ID(), 'cuusinhvien');
